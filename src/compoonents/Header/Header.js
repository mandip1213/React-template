...
const Header = () => {
	const { userId, username, profile_picture } = useGlobalContext()

	return (
		<div className="header">

			<div className="header-logo-text small-screen-only">Brand</div>
				...
				<div className='user-logo'>
					...
					<Link to={`/profile/${userId}`}>
						...
						<img className="user-img"
							src={"https://cdn.pixabay.com/photo/2015/03/04/22/35/head-659652_1280.png"} alt="" />
					</Link>
